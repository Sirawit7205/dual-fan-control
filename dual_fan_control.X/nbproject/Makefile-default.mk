...
# Source Files
SOURCEFILES=mcc_generated_files/adc/src/adc1.c mcc_generated_files/system/src/system.c mcc_generated_files/system/src/protected_io.S mcc_generated_files/system/src/config_bits.c mcc_generated_files/system/src/clock.c mcc_generated_files/system/src/pins.c mcc_generated_files/system/src/interrupt.c mcc_generated_files/timer/src/tcb1.c mcc_generated_files/timer/src/tcb0.c mcc_generated_files/timer/src/tca0.c mcc_generated_files/timer/src/rtc.c mcc_generated_files/vref/src/vref.c main.c millis.c trimpot.c speed_controller.c display.c speed_measurement.c user_interface.c
...
${OBJECTDIR}/user_interface.o: user_interface.c  .generated_files/flags/default/c09d7f2dd979e6338a108266f4ecf596468e9b90 .generated_files/flags/default/3b4533a90d1df7fc7befce2423d400076e91f5c7
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/user_interface.o.d 
	@${RM} ${OBJECTDIR}/user_interface.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=attiny1616 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000UL -Wall -MD -MP -MF "${OBJECTDIR}/user_interface.o.d" -MT "${OBJECTDIR}/user_interface.o.d" -MT ${OBJECTDIR}/user_interface.o  -o ${OBJECTDIR}/user_interface.o user_interface.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/user_interface.o: user_interface.c  .generated_files/flags/default/804f2015dbde1637c04e5c3d02a731b7aa0f8d48 .generated_files/flags/default/3b4533a90d1df7fc7befce2423d400076e91f5c7
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/user_interface.o.d 
	@${RM} ${OBJECTDIR}/user_interface.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=attiny1616 ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS}  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000UL -Wall -MD -MP -MF "${OBJECTDIR}/user_interface.o.d" -MT "${OBJECTDIR}/user_interface.o.d" -MT ${OBJECTDIR}/user_interface.o  -o ${OBJECTDIR}/user_interface.o user_interface.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
